...
const Modal2 = ({ children, show, setShow, activeModale }: Props) => {
	...
	return (
		<>
			{show && (
				<PortalModal wrapperId='test-portal' {...children}>
					{/*<div onClick={() => dispatch(modalOnOffCart('cart'))} className={styles.cart}>*/}
						<div onClick={() => dispatch(modalOnOff(activeModal))} className={rootClasses.join(' ')}>
